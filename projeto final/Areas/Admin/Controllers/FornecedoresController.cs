...
namespace projeto_final.Areas.Admin.Controllers
{
    ...
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cnpj,Razao_Social")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cnpj,Razao_Social")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
